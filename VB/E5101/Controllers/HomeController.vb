...
Namespace E5101.Controllers
	...
	Public Class HomeControllerPdfUploadControlSettings
		Public Shared ValidationSettings As DevExpress.Web.ASPxUploadControl.ValidationSettings = New ValidationSettings() With {.AllowedFileExtensions = New String() { ".pdf" }, .MaxFileSize = 4194304}
